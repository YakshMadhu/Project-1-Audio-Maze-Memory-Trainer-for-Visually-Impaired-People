...
- Make sure the maze has single path
- Compare the path generated by the maze to the user input
- Collect intrnal data which represents the generated path and the user input
- The overall goal is to built an accuracy checking mechanism which is the core part of the 
